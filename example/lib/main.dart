...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      platformVersion = await TemplatePlugin.platformVersion;
  ...
  void _onKeyDown(int key) {
    print("key down:$key");
    TemplatePlugin.onKeyDown(key).then((value) => print(value));
  }

  void _onKeyUp(int key) {
    print("key up:$key");
    TemplatePlugin.onKeyUp(key).then((value) => print(value));
  }
